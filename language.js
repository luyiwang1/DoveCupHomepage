(function (root, factory) {
  ...
  add('Eight spots are available in each draw. Your name appears on the draw immediately.', '男单、女单各有 8 个席位；报名后姓名会立即同步到签表。', 'Eight spots are available in each draw. Your name appears on the draw immediately.');
  ...
  add('Player List', '参赛名单', 'Player List');
  ...
  add('报名需要手机验证账户', '报名需要手机验证账户', 'Phone verification is required to register');
  add('手机登录', '手机登录', 'Phone Sign-In');
  add('加拿大手机号', '加拿大手机号', 'Canadian Phone Number');
  add('首次注册姓名', '首次注册姓名', 'Registration Name');
  add('公开显示的姓名 / 微信名', '公开显示的姓名 / 微信名', 'Public Name / WeChat Name');
  add('默认分级', '默认分级', 'Default Division');
  add('使用手机验证码登录。以后每次报名和到场都会记录到同一个会员身份。', '使用手机验证码登录。以后每次报名和到场都会记录到同一个会员身份。', 'Sign in with an SMS code. Future registrations and attendance will stay with this member identity.');
  add('继续即表示同意将手机号发送给 Google / Firebase，用于身份验证和防滥用。', '继续即表示同意将手机号发送给 Google / Firebase，用于身份验证和防滥用。', 'By continuing, you agree to send your phone number to Google / Firebase for identity verification and abuse prevention.');
  add('发送验证码', '发送验证码', 'Send Code');
  add('短信验证码已发送，请输入 6 位数字完成登录。', '短信验证码已发送，请输入 6 位数字完成登录。', 'The SMS code was sent. Enter the 6-digit code to sign in.');
  add('验证码', '验证码', 'Verification Code');
  add('6 位验证码', '6 位验证码', '6-digit code');
  add('重新发送 / 更换号码', '重新发送 / 更换号码', 'Resend / Change Number');
  add('验证并登录', '验证并登录', 'Verify & Sign In');
  ...
  add('请先完成手机验证', '请先完成手机验证', 'Complete phone verification first');
  ...
  add('短信验证码已发送', '短信验证码已发送', 'SMS code sent');
  add('手机验证成功', '手机验证成功', 'Phone verified');
  add('请重新发送验证码', '请重新发送验证码', 'Please send a new code');
  add('正在建立会员资料…', '正在建立会员资料…', 'Creating member profile…');
  ...
  add('Firebase 短信服务需要先启用按量付费方案。', 'Firebase 短信服务需要先启用按量付费方案。', 'Firebase SMS requires the pay-as-you-go plan.');
  add('请输入正确的加拿大手机号。', '请输入正确的加拿大手机号。', 'Enter a valid Canadian phone number.');
  add('请输入手机号。', '请输入手机号。', 'Enter a phone number.');
  add('验证码不正确，请重新输入。', '验证码不正确，请重新输入。', 'The verification code is incorrect. Try again.');
  add('验证码已经过期，请重新发送。', '验证码已经过期，请重新发送。', 'The verification code expired. Send a new one.');
  add('请先发送验证码。', '请先发送验证码。', 'Send a verification code first.');
  add('安全验证没有通过，请重试。', '安全验证没有通过，请重试。', 'The security check failed. Try again.');
  add('安全验证已过期，请重新发送。', '安全验证已过期，请重新发送。', 'The security check expired. Send a new code.');
  add('短信发送额度已用完，请稍后再试。', '短信发送额度已用完，请稍后再试。', 'The SMS quota has been reached. Try again later.');
