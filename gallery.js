(function (root, factory) {
  ...
  function updateLightbox() {
    ...
    const previous = lightbox.querySelector('.dove-lightbox-prev');
    const next = lightbox.querySelector('.dove-lightbox-next');
    previous.hidden = activePhotos.length < 2;
